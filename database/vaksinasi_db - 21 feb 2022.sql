...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 21 Feb 2022 pada 02.52
...
INSERT INTO `rencana` (`id_rencana`, `tgl_rencana`, `lokasi_vaksin`, `rencana_vaksin`, `id_stok`, `asal_vaksin`) VALUES
(4, '2022-02-05', 'Polres Tuba', '100', 4, 'Jakarta Selatan');
...
(2, 'Sinovac', 100, '2022-02-12', 'Sinovac pertama'),
(3, 'Vaksin Covid-19 Bio Farma', 20, '2022-02-26', 'Bio farma'),
(4, 'Sinopharm', 80, '2022-02-11', 'Sinopharm');
...
--
ALTER TABLE `capaian`
  MODIFY `id_capaian` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `rencana`
  MODIFY `id_rencana` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
