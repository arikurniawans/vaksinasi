<div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Capaian Vakisnasi</h3>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no=1; foreach($capaian as $data){ ?>
                  <tr>
                      <td><?php echo $no++; ?></td>
                      ...
                      <td>
                          <a href="javascript:void(0);" data-toggle="modal" data-target="#editpersonel<?php echo $data->id_capaian; ?>" class="btn btn-flat btn-primary btn-xs">Edit</a>
                          <a href="javascript:void(0);" data-toggle="modal" data-target="#hapuspersonel<?php echo $data->id_capaian; ?>" class="btn btn-flat btn-danger btn-xs">Hapus</a>
                      </td>
                  </tr>

                  <div class="modal fade" id="editpersonel<?php echo $data->id_capaian; ?>">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                            <form action="<?php echo base_url(); ?>capaian/edit" method="post">
                              ...
                              <div class="modal-body">
                                  <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1" name="tgl_vaksin" required value="<?php echo $data->tgl_capaian; ?>">
                                  </div>
                                  <div class="form-group">
                        ...
                        <div class="modal fade" id="hapuspersonel<?php echo $data->id_capaian; ?>">
                        <div class="modal-dialog">
                          <div class="modal-content">
                          <form action="<?php echo base_url(); ?>capaian/delete" method="post">
                            <div class="modal-header" style="background-color: #dc3545; color: white;">
                              <h4 class="modal-title">Hapus Capaian</h4>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-flat btn-default" data-dismiss="modal">Batal</button>
                                <button type="submit" class="btn btn-flat btn-danger">Hapus Data Capaian</button>
                            </div>
                          </div>
                          <!-- /.modal-content -->
                          </form>
  ...
  <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
          <form action="<?php echo base_url(); ?>capaian/create" method="post">
            <div class="modal-header" style="background-color: #17a2b8; color: white;">
              <h4 class="modal-title">Tambah Data Capaian Vaksinasi</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<?php if($this->session->flashdata('message') == 'successfull') { ?>
   swal({
        title: "Berhasil",
        text: "Data capaian berhasil ditambahkan",
        icon: "success",
        button: "OK",
    });
...
<?php if($this->session->flashdata('message2') == 'successfull') { ?>
   swal({
        title: "Berhasil",
        text: "Data capaian berhasil diubah",
        icon: "success",
        button: "OK",
    });
<?php }else if($this->session->flashdata('message2') == 'error') { ?>
  swal({
        title: "Gagal",
        text: "Data capaian gagal diubah !",
        icon: "error",
        button: "OK",
    });
<?php } ?>
